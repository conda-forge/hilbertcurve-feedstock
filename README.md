...
Once the `conda-forge` channel has been enabled, `hilbertcurve` can be installed with:

```
conda install hilbertcurve
```

It is possible to list all of the versions of `hilbertcurve` available on your platform with:
